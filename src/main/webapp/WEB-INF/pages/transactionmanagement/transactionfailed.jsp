<%-- 
    Document   : transactionfailed
    Created on : Jul 3, 2018, 10:53:52 AM
        ...
        <div class="container-main">
            <div class="content-main">
                ...
                <div class="content-table">
                    ...
                    <div></div>
                    <s:url var="listurl" action="SearchTransactionFailed"/>
                    <sjg:grid
                        id="gridtable"
                        ...
                        viewrecords="true"
                        >
                        <sjg:gridColumn name="txnId" index="t.IPGTRANSACTIONID" title="Transaction ID"  sortable="true"/>
                        <sjg:gridColumn name="merchantName" index="m.merchantname" title="Merchant Name"  sortable="true"/>
                        <sjg:gridColumn name="cardHolderName" index="t.CARDNAME" title="Card Holder Name"  sortable="true"/>
                        <sjg:gridColumn name="cardType" index="c.DESCRIPTION" title="Card Association Code"  sortable="true"/>
                        <sjg:gridColumn name="cardNumber" index="t.CARDHOLDERPAN" title="Card Number"  sortable="true"/>
                        <sjg:gridColumn name="amount" index="amount" title="t.AMOUNT"  sortable="true"/>                            
                        <sjg:gridColumn name="status" index="STATUS" title="s.description"  sortable="true"/>
