<%-- 
    Document   : sectioninsert
    Created on : Jul 24, 2018, 10:15:28 AM
    Author     : harini_s
--%>
...
<html>
    ...
    <body>
        ...
        <div class="content-form">
            <s:form id="sectioninsert" method="post" action="Section" theme="simple" cssClass="form">   
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label"  >Section Code<span style="color: red">*</span></label>
                            <s:textfield cssClass="form-control" name="sectioncode" id="isectioncode" maxLength="16" onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z]/g, ''))" onmouseout="$(this).val($(this).val().replace(/[^a-zA-Z]/g, ''))" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                ...
                <s:url var="addurl" action="addSection"/>        
                <div class="row">
