<%-- 
    Document   : userrole
    Created on : Jul 24, 2018, 1:45:45 PM
    Author     : harini_s
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function editformatter(cellvalue) {
                return "<a href='#' title='Edit' onClick='javascript:editUserRoleInit(&#34;" + cellvalue + "&#34;)'><img class='ui-icon ui-icon-pencil' style='display:inline-table;border:none;'/></a>";
            }

            function deleteformatter(cellvalue) {
                return "<a href='#' title='Delete' onClick='javascript:deleteUserRoleInit(&#34;" + cellvalue + "&#34;)'><img class='ui-icon ui-icon-trash' style='display:inline-table;border:none;'/></a>";
            }
            ...
            $.subscribe('openviewuserroletopage', function (event, data) {
                var $led = $("#updatedialog");
                $led.html("Loading..");
                $led.load("detailUserRole.ipg?userRoleCode=" + $led.data('userRoleCode'));
            });
            ...
            function deleteUserRole(keyval) {
                $.ajax({
                    url: '${pageContext.request.contextPath}/deleteUserRole.ipg',
            ...
            <div class="container-main">
                <div class="content-main">
                    ...
                    <s:set var="vsearch"><s:property value="vsearch" default="true"/></s:set>
                        ...
                        <s:form id="userrolesearch" method="post" action="UserRole" theme="simple" >

                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" >User Role Code</label>
                                        <s:textfield cssClass="form-control" name="searchUserRoleCode" id="userRoleCode" maxLength="16" onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z]/g, ''))" onmouseout="$(this).val($(this).val().replace(/[^a-zA-Z]/g, ''))"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:select cssClass="form-control" id="userRoleType" list="%{userRoleTypeList}" name="searchUserRoleType" headerKey="" headerValue="--Select--" listKey="userroletypecode" listValue="description"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <sj:submit cssClass="btn btn-sm btn-functions" button="true" href="#" value="Search" targets="divmsg" id="search"  disabled="#vsearch" onclick="searchUserRole()"/>
                                        <sj:submit cssClass="btn btn-sm btn-reset" button="true" value="Reset" name="reset" onClick="resetAllData()" />
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                                <div class="col-sm-3 text-right">
                                    <s:url var="addurlLink" action="viewpopupUserRole"/>
                                    <div class="form-group">
                                        <sj:submit 
                    ...
                    <sj:dialog                                     
                        ...
                        onOpenTopics="openviewuserroletopage" 
                        loadingText="Loading .."
                        width="1000"
                        height="500"
                        cssStyle="overflow: visible;"
                    ...
                    <div class="content-table">
                        ...
                        <sjg:grid
                            ...
                            viewrecords="true"
                            >
                            <sjg:gridColumn name="userRoleCode" index="userrolecode" title="Edit" width="25" align="center" formatter="editformatter" hidden="#vupdatelink"/>
                            <sjg:gridColumn name="userRoleCode" index="userrolecode" title="Delete" width="40" align="center" formatter="deleteformatter" hidden="#vdelete"/>
                            <sjg:gridColumn name="userRoleCode" index="userrolecode" title="User Role Code" sortable="true"/>
                            <sjg:gridColumn name="description" index="description" title="Description" sortable="true"/>
                            <sjg:gridColumn name="userRoleTypeDes" index="ipguserroletype.userroletypecode" title="User Role Type" sortable="true"/>
                            <sjg:gridColumn name="statusDes" index="ipgstatus.statuscode" title="Status" sortable="true"/>
