<%-- 
    Document   : merchantcredentialinsert
    Created on : Jul 19, 2018, 2:45:23 PM
...
//                });
    ...
    <body  >
        ...
        <div class="content-form">
            <s:form id="merchantcredentialinsert" method="post" action="MerchantCredential" theme="simple" cssClass="form" enctype="multipart/form-data">   
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >Merchant ID <span style="color: red">*</span></label>
                            <s:select cssClass="form-control" id="imerchantID" list="%{merchantList}"  name="merchantID" headerKey="" headerValue="--Select Merchant--"  listKey="merchantid" listValue="merchantid" />
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <s:textfield cssClass="form-control" id="iuserName" name="userName" maxLength="255" onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g,''))" onmouseout="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g,''))" />
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <s:password cssClass="form-control" id="ipassword" name="password" maxLength="255"  />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >Re-type Password <span style="color: red">*</span></label>
                            <s:password cssClass="form-control" id="irePassword" name="rePassword" maxLength="255"  />
                        </div>
                    </div>
                </div>
                ...
                <s:url var="addurl" action="addMerchantCredential"/>        
                <div class="row">
