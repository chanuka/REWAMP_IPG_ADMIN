<%-- 
    ...
    Created on : Jul 16, 2018, 2:40:21 PM
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function searchHeadMerchants() {
                ...
                var city = $('#city').val();
                var email = $('#email').val();
                var authreqstatus = $('#authreqstatus').val();
                ...
                <div class="content-main">
                    ...
                    <s:set var="vsearch"><s:property value="vsearch" default="true"/></s:set>
                        ...
                        <s:form id="headmerchants" method="post" action="HeadMerchants" theme="simple">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="control-label" >Authentication Required Status</label>
                                        <s:select cssClass="form-control" id="authreqstatus" list="authreqstatusList" name="authreqstatus" headerKey="" headerValue="--Select Status--" listKey="statuscode" listValue="description"  />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                    ...
                    <div class="content-table">
                        ...
                        <sjg:grid
                            ...
                            <sjg:gridColumn name="merchantid" index="u.transactioninitaiatedmerchntid" title="Merchant ID"  sortable="true"/> 
                            <sjg:gridColumn name="merchantname" index="u.merchantname" title="Merchant Name"  sortable="true"/> 
                            <sjg:gridColumn name="address1" index="u.ipgaddress.address1" title="Address"  sortable="true"/>
                            ...
                            <sjg:gridColumn name="authreqstatus" index="u.ipgstatusByAuthenticationrequied.statuscode" title="Authentication Required Status"  sortable="true"/>
