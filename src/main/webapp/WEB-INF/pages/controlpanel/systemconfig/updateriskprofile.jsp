                    ...
                    <div class="content-form">
                        ...
                        <s:form action="MerchantRiskProfile" theme="simple" method="post" id="addform" name="addform" target="divmsg" >
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield cssClass="form-control" name="riskprofilecode" id="riskprofilecode" readonly="true"
                                                     maxLength="16" 
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="maxsingletxnlimit" id="maxsingletxnlimit" cssClass="form-control"
                                                     maxLength="16" 
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="minsingletxnlimit" id="minsingletxnlimit" cssClass="form-control"
                                                     maxLength="16" 
                                                     onkeyup="$(this).val($(this).val().replace(/[^0-9 ]/g,''))" 
                                                     onmouseout="$(this).val($(this).val().replace(/[^0-9 ]/g,''))"/>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="maxtxncount" id="maxtxncount" cssClass="form-control"
                                                     maxLength="16" 
                                                     onkeyup="$(this).val($(this).val().replace(/[^0-9 ]/g,''))" 
                                                     onmouseout="$(this).val($(this).val().replace(/[^0-9 ]/g,''))"/>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="maxtxnamount" id="maxtxnamount" cssClass="form-control"
                                                     maxLength="64" 
                                                     onkeyup="$(this).val($(this).val().replace(/[^0-9 ]/g,''))" 
                                                     onmouseout="$(this).val($(this).val().replace(/[^0-9 ]/g,''))"/>
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <s:textfield name="maxpasswordcount" id="maxpasswordcount" cssClass="form-control" 
                                                     maxLength="16" 
                                                     onkeyup="$(this).val($(this).val().replace(/[^0-9 ]/g,''))" 
                                                     onmouseout="$(this).val($(this).val().replace(/[^0-9 ]/g,''))"/>
                                    </div>
                            ...
                            <div class="move-change-side">
                                <table>
                                    ...
                                    <tr style="display: none; visibility: hidden;">
                                        <td><s:url var="upurl" action="updateMerchantRiskProfile" />
                                            <sj:submit button="true" href="%{upurl}" id="upbuta"
                                                       targets="divmsg" /></td>
                                    </tr>
                                </table>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <sj:a cssClass="btn btn-sm btn-functions" button="true" id="addbuta" onclick="clickUpdate()" disabled="#vupdatebutt">Add</sj:a> 
                                        <sj:submit cssClass="btn btn-sm btn-reset" button="true" value="Reset" name="reset" onClick="window.location.reload(true)" />
                                    </div>
                                </div>
                            </div>
                        </s:form>
