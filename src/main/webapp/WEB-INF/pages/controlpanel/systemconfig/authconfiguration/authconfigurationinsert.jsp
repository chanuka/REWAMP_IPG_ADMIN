<%-- 
    Document   : authconfigurationinsert
    Created on : Jul 9, 2018, 1:20:46 PM
...
//                });
    ...
    <body  >
        ...
        <div class="content-form">
            <s:form id="cardassociationinsert" method="post" action="AuthConfig" theme="simple" cssClass="form" enctype="multipart/form-data">   
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <s:select cssClass="form-control" id="itxstatus" list="%{txstatusMap}"  name="txstatus" headerKey="" headerValue="--Select Authentication Status--" listKey="key" listValue="value" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >ECI Value <span style="color: red">*</span></label>
                            <s:select cssClass="form-control" id="iecivalue" list="%{ecivalueList}"  name="ecivalue" headerKey="" headerValue="--Select ECI Value--" listKey="value" listValue="value" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >Authentication Status <span style="color: red">*</span></label>
                            <s:select cssClass="form-control" id="istatus" list="%{authstatusList}"  name="status" headerKey="" headerValue="--Select Status--" listKey="statuscode" listValue="description" />
                        </div>
                    </div>
                </div>
                <div class="row">
