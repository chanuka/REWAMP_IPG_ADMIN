<%-- 
    Document   : ipginfoinsert
    Created on : Jul 10, 2018, 2:06:51 PM
...
//                });
    ...
    <body  >
        ...
        <div class="content-form">
            <s:form id="ipgmpiinfoserveletinsert" method="post" action="IPGMPIInfoServelet" theme="simple" cssClass="form" enctype="multipart/form-data">   
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >Primary URL <span style="color: red">*</span> </label>
                            <s:textfield cssClass="form-control" name="primaryUrl" id="iprimaryUrl" maxLength="250" />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label" >Secondary URL <span style="color: red">*</span> </label>
                            <s:textfield cssClass="form-control" name="secondaryUrl" id="isecondaryUrl" maxLength="250" />
                        </div>
                    </div>
                </div> 
                <div class="row">
