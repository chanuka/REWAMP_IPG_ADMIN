<%-- 
    Document   : countryinsert
    Created on : Jul 12, 2018, 11:22:12 AM
...
//                });
    ...
    <body  >
        ...
        <div class="content-form">
            <s:form id="countryinsert" method="post" action="Country" theme="simple" cssClass="form" enctype="multipart/form-data">   
                <div class="row">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <s:textfield cssClass="form-control" name="countryisocode" id="icountryisocode" maxLength="3"
                                         onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g,''))"
                                         onmouseout="$(this).val($(this).val().replace(/[^a-zA-Z0-9 ]/g,''))" />
                        </div>
                    </div>
                ...
                <s:url var="addurl" action="addCountry"/>
                <div class="row">
