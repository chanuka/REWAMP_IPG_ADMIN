<%-- 
    Document   : country
    Created on : 31/10/2013, 11:31:30 AM
    Author     : asitha_l
--%>
    ...
    <head>
        ...
        <script type="text/javascript">
            function editformatter(cellvalue) {
                ...
                return "<a href='#' title='Edit' onClick='javascript:editCountry(&#34;"
                        + cellvalue
            ...
            function resetAllData() {
                ...
                if (a == true && u == true) {
                    ...
                    var merchantCategoryCode = $('#countryCode').val();
                    $('#countryCode').attr('readOnly', true);
            ...
            <div class="container-main">
                <div class="content-main">
                    ...
                    <div class="content-form">
                        <s:form id="mccadd" method="post" action="MerchantCategory" theme="simple">
