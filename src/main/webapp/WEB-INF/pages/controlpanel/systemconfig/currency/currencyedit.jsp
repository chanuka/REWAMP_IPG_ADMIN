<%-- 
    Document   : currencyedit
    Created on : Jul 12, 2018, 1:50:37 PM
...
<html>
    <head>
        <script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (msg) {
                            ...
                            $('#ecurrencyISOCode').val(data.currencyISOCode);
                            $('#ecurrencyISOCode').attr('readOnly', true);
                            $('#ecurrencyCode').val(data.currencyCode);
            ...
            function cancelUpateData() {
                var currencyISOCode = $('#ecurrencyISOCode').val();
    ...
    <body >
        ...
        <div class="content-form">
            <s:form id="currencyedit" method="post" action="Currency"  theme="simple" cssClass="form" enctype="multipart/form-data"> 
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label">Currency ISO Code <span style="color: red">*</span></label>
                            <s:textfield cssClass="form-control" name="currencyISOCode" id="ecurrencyISOCode" maxLength="8" onkeyup="$(this).val($(this).val().replace(/[^0-9]/g,''))" onmouseout="$(this).val($(this).val().replace(/[^0-9]/g,''))" readonly="true"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="control-label">Currency Code <span style="color: red">*</span></label>
                            <s:textfield  cssClass="form-control" id="ecurrencyCode"   name="currencyCode" maxLength="3" onkeyup="$(this).val($(this).val().replace(/[^a-zA-Z]/g,''))" onmouseout="$(this).val($(this).val().replace(/[^a-zA-Z]/g,''))"  />
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
