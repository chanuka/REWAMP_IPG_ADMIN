 ...
 * @author Chalitha
 */
public class HeadMerchantAction extends ActionSupport implements ModelDriven<Object>, AccessControlService {
...
//            inputBean.setMessage(MessageVarList.COMMON_ERROR_DELETE);
    ...
    private String validateInputs() {
        ...
        } else if (inputBean.getDynamicreturnsuccessurl() == null
                || inputBean.getDynamicreturnsuccessurl().trim().isEmpty()) {
            message = MessageVarList.HM_MGT_EMPTY_SUCCESS_URL;
        } else if (inputBean.getDynamicreturnerrorurl() == null
