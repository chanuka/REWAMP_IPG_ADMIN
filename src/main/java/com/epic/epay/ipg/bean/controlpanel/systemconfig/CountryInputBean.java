...
public class CountryInputBean {
	...
	/*------------------------list data table  ------------------------------*/
	private List<CountryDataBean> gridModel;
	...
	public List<CountryDataBean> getGridModel() {
		return gridModel;
	}
	public void setGridModel(List<CountryDataBean> gridModel) {
