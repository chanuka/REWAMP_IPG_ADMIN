 ...
 * @author chalitha
 */
public class RuleScopeInputBean {
    ...
    /*------------------------list data table  ------------------------------*/
    private List<RuleScopeBean> gridModel;
    ...
    public List<RuleScopeBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<RuleScopeBean> gridModel) {
