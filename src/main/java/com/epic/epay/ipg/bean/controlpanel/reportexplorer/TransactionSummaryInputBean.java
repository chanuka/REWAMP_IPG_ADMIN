...
/**
 *
 * Created on  :Sep 15, 2014, 2:50:52 PM
 * @author 	   :thushanth
 *
 */
public class TransactionSummaryInputBean {
    ...
    private List<TransactionSummaryBean> lst;
    private long fullCount;
    /*------------------------list data table  ------------------------------*/
    private List<TransactionSummaryBean> gridModel;
	...
	public List<TransactionSummaryBean> getLst() {
		return lst;
	}
	public void setLst(List<TransactionSummaryBean> lst) {
		this.lst = lst;
	}
	...
	public List<TransactionSummaryBean> getGridModel() {
		return gridModel;
	}
	public void setGridModel(List<TransactionSummaryBean> gridModel) {
