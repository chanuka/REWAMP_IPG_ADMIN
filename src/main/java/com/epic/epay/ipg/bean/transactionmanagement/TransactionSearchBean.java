...
public class TransactionSearchBean {
    ...
    private List<TransactionDataBean> gridModel;
    ...
    public List<TransactionDataBean> getGridModel() {
        return gridModel;
    }

    public void setGridModel(List<TransactionDataBean> gridModel) {
    ...
    public boolean isVvoid() {
        return vvoid;
    }

    public void setVvoid(boolean vvoid) {
        this.vvoid = vvoid;
    }

    public boolean isVreversal() {
        return vreversal;
    }

    public void setVreversal(boolean vreversal) {
        this.vreversal = vreversal;
    }
